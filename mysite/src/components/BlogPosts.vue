    ...
    <div class="row">
        ...
        <div class="all-blog-posts">
            ...
            <div class="col-lg-12">
                ...
                <div class="down-content">
                    <span>Lifestyle</span>
                    <a href="../../public/post-details.html"><h4>Best Template Website for HTML CSS</h4></a>
                    <ul class="post-info">
            ...
            <div class="col-lg-12">
                <div class="blog-post">
                <div class="blog-thumb">
                    <img src="../../public/assets/images/blog-post-02.jpg" alt="">
                </div>
                <div class="down-content">
                    <span>Healthy</span>
                    <a href="../../public/post-details.html"><h4>Etiam id diam vitae lorem dictum</h4></a>
                    <ul class="post-info">
                    <li><a href="#">Admin</a></li>
            ...
            <div class="col-lg-12">
                <div class="blog-post">
                <div class="blog-thumb">
                    <img src="../../public/assets/images/blog-post-03.jpg" alt="">
                </div>
                <div class="down-content">
                    <span>Fashion</span>
                    <a href="../../public/post-details.html"><h4>Donec tincidunt leo nec magna</h4></a>
                    <ul class="post-info">
                    <li><a href="#">Admin</a></li>
            ...
            <div class="col-lg-12">
                ...
                <a href="../../public/blog.html">View All Posts</a>
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="sidebar">
            ...
            <div class="col-lg-12">
                ...
                <div class="content">
                    <ul>
                    <li><a href="../../public/post-details.html">
